<template>
    <div class=" max-w-[1440px] mx-auto  pl-[120px] pr-[118px] mt-28">
        <div class="flex  rounded-[14px] bg-[#F4F4F4] py-2 px-[10px]">
            <div class="flex flex-col bg-[#51CCF3] pt-[27px] pl-[21px] pr-[34px] 
          max-w-[365px] rounded-[10px] h-auto">
                <h3 class="text-white   text-[32px] leading-[39px] font-medium">TTS & STT tizimlarini o'rnatish reja qilingan sohalar</h3>
            </div>
